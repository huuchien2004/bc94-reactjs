    ...
    >
      ...
      <div className="relative h-56 overflow-hidden rounded-base md:h-96">
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
          <img
            src="./images/carousel-lights-creating-swirling-patterns-of-illumination-at-night.webp"
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
          <img
            src="./images/ferrari-laferrari.webp"
            className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="..."
          />
        </div>
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
          <img
            src="./images/red-lamborghini-aventador-showing-its-wheel-and-side-in-a-showroom-free-photo.webp"
            className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="..."
          />
        </div>
