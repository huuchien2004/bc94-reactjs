export default function Cart(props) {
  const { listCart, onDeleteToCart, onUpdateQty } = props;
        ...
        <tr className="border-b" key={phone.maSP}>
          ...
          <td className="px-4 py-3">
            <div className="flex items-center gap-2">
              <button
                onClick={() => onUpdateQty(phone.maSP, false)}
              ...
              <span className="font-semibold text-gray-800 w-6 text-center">{phone.soLuong}</span>
              <button
                onClick={() => onUpdateQty(phone.maSP, true)}
                className="px-3 py-1 bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold rounded-md transition duration-150"
              >
                +
              </button>
          ...
          <td className="px-4 py-3 text-center">
            <button onClick={() => onDeleteToCart(phone.maSP)} className="rounded bg-red-500 px-3 py-1 text-white hover:bg-red-600">
              Delete
            </button>
          </td>
        </tr>
